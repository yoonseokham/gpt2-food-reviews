...
tokenizer = AutoTokenizer.from_pretrained("mrm8488/dilstilgpt2-finetuned-amazon-food-reviews")
model = AutoModelWithLMHead.from_pretrained("mrm8488/dilstilgpt2-finetuned-amazon-food-reviews", return_dict=True)
